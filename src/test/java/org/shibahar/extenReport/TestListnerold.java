...
//
//public class TestListnerold implements ITestListener {
...
//        extentTest=
//
//        ExtentManager.getInstance().createTest("DYNAMIC_LINK_VALIDATION");
...
//        ExtentManager.getTest().get().assignCategory(iTestResult.getMethod().getMethodName());
